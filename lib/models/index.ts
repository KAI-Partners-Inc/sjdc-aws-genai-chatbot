    ...
    if (
      ...
      const mistral7B = new HuggingFaceSageMakerEndpoint(
        ...
        "Mistral7BInstruct",
        {
          ...
          container:
            DeepLearningContainerImage.HUGGINGFACE_PYTORCH_TGI_INFERENCE_2_1_1_TGI1_2_0_GPU_PY310_CU121_UBUNTU20_04,
    ...
    if (
      ...
      const mistral7BInstruct2 = new HuggingFaceSageMakerEndpoint(
        ...
        "Mistral7BInstruct2",
        {
          ...
          container: DeepLearningContainerImage.HUGGINGFACE_PYTORCH_TGI_INFERENCE_2_1_1_TGI1_2_0_GPU_PY310_CU121_UBUNTU20_04,
          instanceType: SageMakerInstanceType.ML_G5_2XLARGE,
          startupHealthCheckTimeoutInSeconds: 300,
